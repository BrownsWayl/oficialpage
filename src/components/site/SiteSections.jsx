...
export function PageDisclaimer() {
  return (
    <div className="site-disclaimer">
     風險披露：在德生進行保證金交易涉及高風險，可能並不適合所有投資者。在進行任何融資融券交易前，您應仔細考慮您的投資目標、財務狀況、要求和經驗水平，並在必要時諮詢獨立的專業顧問。貴金屬是槓桿產品，這意味着利潤和損失都會被放大。只有在充分了解所涉及的風險並能夠承擔損失（包括全部初始投資本金的損失）的情況下，您才應從事此類交易。在決定使用我們的產品或服務之前，您必須仔細評估和仔細考慮。
免責聲明：本網站所提供的資料屬一般性質，不包含任何個人財務建議。在使用本網站的信息之前，您應該根據自己的目標、財務狀況和需求評估其適用性。交易貴金屬產品及使用保證金涉及高風險，未必適合所有投資者。在交易過程中，您可能會遭受超過初始存款金額的損失。閣下並不擁有或受惠於合約所涉及的標的資產。我們建議您在決定買賣本網站提供的金融產品前，尋求專業意見，以確保您充分了解所涉及的風險，並仔細閱讀我們的用戶條款、風險警告、隱私政策和其他相關披露信息。本網站提供的產品和服務不針對美國居民。本網站的信息不面向任何特定國家的普通公衆，也不打算向發生違反法律、法規或監管要求的任何司法管轄區分發。
    </div>
  );
}
